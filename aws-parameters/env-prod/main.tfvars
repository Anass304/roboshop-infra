parameters = [
  { name = "prod.frontend.catalogue_url", value = "http://catalogue-prod.anassdevops.online:80/", type = "String" },
  { name = "prod.frontend.user_url", value = "http://user-prod.anassdevops.online:80/", type = "String" },
  { name = "prod.frontend.cart_url", value = "http://cart-prod.anassdevops.online:80/", type = "String" },
  { name = "prod.frontend.shipping_url", value = "http://shipping-prod.anassdevops.online:80/", type = "String" },
  { name = "prod.frontend.payment_url", value = "http://payment-prod.anassdevops.online:80/", type = "String" },
  { name = "prod.user.mongo", value = "true", type = "String" },
  { name = "prod.user.redis_host", value = "redis-prod.anassdevops.online", type = "String" },
  { name = "prod.user.mongo_url", value = "mongodb://mongodb-prod.anassdevops.online:27017/catalogue", type = "String" },
  { name = "prod.shipping.cart_endpoint", value = "cart:8080", type = "String" },
  { name = "prod.shipping.db_host", value = "mysql-prod.anassdevops.online", type = "String" },
  ...
  { name = "prod.payment.amqp_host", value = "rabbitmq-prod.anassdevops.online", type = "String" },
  { name = "prod.catalogue.mongo", value = "true", type = "String" },
  { name = "prod.catalogue.mongo_url", value = "mongodb://mongodb-prod.anassdevops.online:27017/users", type = "String" },
  { name = "prod.cart.redis_host", value = "redis-prod.anassdevops.online", type = "String" },
  { name = "prod.cart.catalogue_host", value = "catalogue-prod.anassdevops.online", type = "String" },
